...
::DDS::DataWriter_ptr MyMessageTypeSupportImpl::create_datawriter()
{
  typedef OpenDDS::DCPS::DataWriterImpl_T<MyMessage> DataWriterImplType;
...
::DDS::DataReader_ptr MyMessageTypeSupportImpl::create_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<MyMessage> DataReaderImplType;
...
::DDS::DataReader_ptr MyMessageTypeSupportImpl::create_multitopic_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<MyMessage> DataReaderImplType;
  typedef OpenDDS::DCPS::MultiTopicDataReader_T<MyMessage, DataReaderImplType> MultiTopicDataReaderImplType;
...
const OpenDDS::DCPS::MetaStruct& MyMessageTypeSupportImpl::getMetaStructForType()
{
  return OpenDDS::DCPS::getMetaStruct<MyMessage>();
}
#endif /* !OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE */

bool MyMessageTypeSupportImpl::has_dcps_key()
{
  return TraitsType::gen_has_key ();
}

const char* MyMessageTypeSupportImpl::default_type_name() const
{
  return TraitsType::type_name();
}

MyMessageTypeSupport::_ptr_type MyMessageTypeSupportImpl::_narrow(CORBA::Object_ptr obj)
{
...
template<>
struct MetaStructImpl<MyMessenger::MyMessage> : MetaStruct {
  typedef MyMessenger::MyMessage T;
  ...
  {
    const MyMessenger::MyMessage& typed = *static_cast<const MyMessenger::MyMessage*>(stru);
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct MyMessenger::MyMessage)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct MyMessenger::MyMessage");
  }
...
{
  static MetaStructImpl<MyMessenger::MyMessage> msi;
  return msi;
}
...
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<MyMessenger::MyMessage>().getValue(ser, "");
  return true;
}
